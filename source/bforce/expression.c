...
#line 93 "bforce/expression.y"
    {
		DEB((D_EVENT, "[yacc] expression return %d", (yyvsp[(1) - (1)])));
		expr_result = (yyvsp[(1) - (1)]);
	}
    break;
...
#line 99 "bforce/expression.y"
    {
		DEB((D_EVENT, "[yacc] elemexp return %d", (yyvsp[(1) - (1)])));
		(yyval) = (yyvsp[(1) - (1)]);
	}
    break;
...
#line 104 "bforce/expression.y"
    {
		DEB((D_EVENT, "[yacc] not exprression %d", (yyvsp[(2) - (2)])));
		if( ((yyvsp[(2) - (2)])) < 0 )
			(yyval) = 0;
		else
			(yyval) = !((yyvsp[(2) - (2)]));
...
#line 112 "bforce/expression.y"
    {
		(yyval) = expr_check_logic((yyvsp[(1) - (3)]), (yyvsp[(2) - (3)]), (yyvsp[(3) - (3)]));
	}
    break;
...
#line 116 "bforce/expression.y"
    {
		DEB((D_EVENT, "eventexp: [yacc] backeted.expr %d", (yyvsp[(2) - (3)])));
		(yyval) = (yyvsp[(2) - (3)]);
	}
    break;
...
#line 142 "bforce/expression.y"
    {
		if( state.valid && state.connspeed > 0 )
			(yyval) = expr_check_arop(state.connspeed, (yyvsp[(2) - (3)]), (yyvsp[(3) - (3)]));
		else
			(yyval) = -1;
	}
    break;
...
#line 149 "bforce/expression.y"
    {
		if( state.valid && state.node.speed > 0 )
			(yyval) = expr_check_arop(state.node.speed, (yyvsp[(2) - (3)]), (yyvsp[(3) - (3)]));
		else
			(yyval) = -1;
	}
    break;
...
#line 156 "bforce/expression.y"
    {
		(yyval) = expr_check_arop(time_gmtoffset(), (yyvsp[(2) - (3)]), (yyvsp[(3) - (3)]));
	}
    break;
...
#line 195 "bforce/expression.y"
    {
		(yyval) = expr_check_logic((yyvsp[(1) - (3)]), OR, (yyvsp[(3) - (3)]));
	}
    break;
